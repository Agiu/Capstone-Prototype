...
function RatingRow({ pct, line1, line2 }) {
  return (
      ...
      <div className="pointer-events-none absolute right-[16px] top-[62px] z-10 flex h-[236px] w-[250px] flex-col justify-between group-hover:pointer-events-auto">
        <div className="flex flex-col gap-[24px]">
          <div className="flex flex-col gap-[8px] text-[#e7e7e7]">
            <p className="text-[16px] font-semibold leading-tight">{details.title}</p>
        ...
        <div className="flex w-full items-start justify-end gap-[16px]">
          <div className="flex items-center gap-[4px] whitespace-nowrap text-[12px] text-[#e7e7e7]">
            <div className="grid size-[12px] grid-cols-2 grid-rows-2 gap-px">
            ...
            <span>·</span>
            <img alt="" src={appleLogo} className="h-[14px] w-[12px]" />
            <span>·</span>
            <span>XBOX</span>
            <span>·</span>
            <span>PS4</span>
          </div>
          <div className="flex w-[48px] items-center gap-[8px]">
        ...
        {featured ? (
          ...
          <div className="flex items-center gap-[8px]">
            <img
              alt="On Game Pass"
              src={xboxPriceIcon}
              className="size-[36px] rounded-[4px] object-cover shadow-[0px_0px_8px_0px_rgba(149,255,0,0.25)]"
            />
            <img alt="Play" src={playOwned} className="size-[50px]" />
          </div>
        ) : (
          <div className="flex items-center gap-[8px]">
            <div className="flex items-center overflow-hidden rounded-[4px] bg-[#107c10] pr-0 transition-all duration-300 ease-out group-hover:pr-[8px]">
              <img alt="" src={xboxPriceIcon} className="size-[36px] shrink-0 rounded-[4px] object-cover" />
              <span className="ml-0 max-w-0 overflow-hidden whitespace-nowrap text-[12px] font-semibold text-white opacity-0 transition-all duration-300 ease-out group-hover:ml-[4px] group-hover:max-w-[70px] group-hover:opacity-100">
                {details.pass}
              </span>
            </div>
            <img alt="" src={dividerV} className="h-[32.5px] w-px shrink-0" />
            <div className="flex items-center gap-[8px] rounded-[4px] bg-[#242429] px-[8px] py-[2px] whitespace-nowrap">
              ...
              <span className="text-[12px] text-white">$26.08</span>
            </div>
          </div>
        )}
      </div>
...
const acDetails = {
  ...
  ratings: [
    ...
    { pct: '72%', line1: 'of who played', line2: 'Minecraft' },
  ],
}
...
const minecraftDetails = {
  ...
  ratings: [
    ...
    { pct: '88%', line1: 'of who played', line2: 'Roblox' },
  ],
}
...
export default function RecServer() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative shrink-0 origin-center text-white"
      ...
      >
        ...
        <div className="absolute left-[478px] top-[128px] flex w-[1532px] flex-col overflow-hidden py-[16px]">
          {/* Header row (search / bookmark) */}
          <div className="flex w-full items-end justify-end">
            <div className="flex w-[245px] items-center justify-end gap-[20px]">
          ...
          {/* Love Exploring the World Together? */}
          <div className="mt-[56px] flex w-full flex-col gap-[20px]">
